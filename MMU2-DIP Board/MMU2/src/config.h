...
// Set Chopper Voltage: CHOPPER_DEFAULT_12V, CHOPPER_DEFAULT_19V, or CHOPPER_DEFAULT_24V
...
#define TMC_SG_THR_SEL     60  //TMC2209 set to about 50, TMC2130 Set to about 31
