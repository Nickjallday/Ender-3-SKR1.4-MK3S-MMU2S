...
//#define HOMING_BACKOFF_POST_MM { 4, 2, 0 }  // (mm) Backoff from endstops after homing
 ...
 */
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       500 // 70% of 725mA
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT      500 // 70% of 725mA
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      800 // 80% of 1000mA
